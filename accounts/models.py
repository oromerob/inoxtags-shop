...
class InoxUser(AbstractBaseUser,PermissionsMixin):
    ...
    shipping_code = models.CharField(max_length=5,verbose_name=_('postal code'), blank=True, null=True)
    shipping_town = models.CharField(max_length=200,verbose_name=_('town'), blank=True, null=True)
    shipping_country = models.ForeignKey(Country,verbose_name=_('country'), blank=True, null=True)
    #Invoice optional data
    invoice_required = models.BooleanField(default=False,verbose_name=_('wants invoice'))
    invoice_name = models.CharField(max_length=255,verbose_name=_('legal name'),blank=True,null=True)
    invoice_tax_code = models.CharField(max_length=50,verbose_name=_('tax code'),blank=True,null=True)
    invoice_extra_charge = models.BooleanField(default=False,verbose_name=_('extra charge for equivalence only for spanish professional customers'))
    invoice_address = models.CharField(max_length=255,verbose_name=_('legal address'),blank=True,null=True)
    invoice_code = models.CharField(max_length=5,verbose_name=_('postal code'),blank=True,null=True)
