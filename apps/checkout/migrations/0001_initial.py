...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Iva'
        db.create_table(u'checkout_iva', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('iva', self.gf('django.db.models.fields.DecimalField')(max_digits=4, decimal_places=2)),
            ('is_active', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal(u'checkout', ['Iva'])
        ...
        db.create_table(u'checkout_order', (
            ...
            ('hand_delivery', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ...
            ('shipping_code', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
        ...
        db.create_table(u'checkout_orderitem', (
            ...
            ('front_main', self.gf('django.db.models.fields.CharField')(max_length=15)),
        ...
        db.create_table(u'checkout_invoice', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('creation_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.InoxUser'])),
            ('order', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['checkout.Order'], null=True, blank=True)),
            ('concept', self.gf('django.db.models.fields.CharField')(max_length=200, blank=True)),
            ('price', self.gf('django.db.models.fields.DecimalField')(max_digits=6, decimal_places=2)),
            ('iva', self.gf('django.db.models.fields.DecimalField')(max_digits=4, decimal_places=2)),
            ('rect', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'checkout', ['Invoice'])

        # Adding model 'RectInvoice'
        db.create_table(u'checkout_rectinvoice', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('creation_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.InoxUser'])),
            ('invoice', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['checkout.Invoice'])),
            ('price', self.gf('django.db.models.fields.DecimalField')(max_digits=6, decimal_places=2)),
            ('iva', self.gf('django.db.models.fields.DecimalField')(max_digits=4, decimal_places=2)),
        ))
        db.send_create_signal(u'checkout', ['RectInvoice'])

        # Adding model 'PreOrder'
        db.create_table(u'checkout_preorder', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('creation_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('cart', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['shop.Cart'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.InoxUser'])),
        ...
        db.send_create_signal(u'checkout', ['PreOrder'])


    def backwards(self, orm):
        # Deleting model 'Iva'
        db.delete_table(u'checkout_iva')
        ...
        db.delete_table(u'checkout_invoice')

        # Deleting model 'RectInvoice'
        db.delete_table(u'checkout_rectinvoice')

        # Deleting model 'PreOrder'
        db.delete_table(u'checkout_preorder')
