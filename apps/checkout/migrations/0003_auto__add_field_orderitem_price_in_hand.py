...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OrderItem.price_in_hand'
        db.add_column(u'checkout_orderitem', 'price_in_hand',
                      self.gf('django.db.models.fields.DecimalField')(default=2, max_digits=5, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'OrderItem.price_in_hand'
        db.delete_column(u'checkout_orderitem', 'price_in_hand')
