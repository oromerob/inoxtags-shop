...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Order.to'
        db.add_column(u'checkout_order', 'to',
                      self.gf('django.db.models.fields.CharField')(default=2, max_length=200),
                      keep_default=False)

        # Adding field 'Order.address'
        db.add_column(u'checkout_order', 'address',
                      self.gf('django.db.models.fields.CharField')(default=2, max_length=200),
                      keep_default=False)

        # Adding field 'Order.postal_code'
        db.add_column(u'checkout_order', 'postal_code',
                      self.gf('django.db.models.fields.CharField')(default=2, max_length=8),
                      keep_default=False)

        # Adding field 'Order.town'
        db.add_column(u'checkout_order', 'town',
                      self.gf('django.db.models.fields.CharField')(default=2, max_length=100),
                      keep_default=False)

        # Adding field 'Order.country'
        db.add_column(u'checkout_order', 'country',
                      self.gf('django.db.models.fields.CharField')(default=2, max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Order.to'
        db.delete_column(u'checkout_order', 'to')

        # Deleting field 'Order.address'
        db.delete_column(u'checkout_order', 'address')

        # Deleting field 'Order.postal_code'
        db.delete_column(u'checkout_order', 'postal_code')

        # Deleting field 'Order.town'
        db.delete_column(u'checkout_order', 'town')

        # Deleting field 'Order.country'
        db.delete_column(u'checkout_order', 'country')
