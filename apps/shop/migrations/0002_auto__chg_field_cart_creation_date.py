...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'shop_cart', 'creation_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

    def backwards(self, orm):

        # Changing field 'Cart.creation_date'
        db.alter_column(u'shop_cart', 'creation_date', self.gf('django.db.models.fields.DateTimeField')())
