...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Category.price_in_hand'
        db.add_column(u'shop_category', 'price_in_hand',
                      self.gf('django.db.models.fields.DecimalField')(default=2, max_digits=5, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Category.price_in_hand'
        db.delete_column(u'shop_category', 'price_in_hand')
